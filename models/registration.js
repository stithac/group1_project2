...
module.exports = (sequelize, DataTypes) => {
  ...
  // Creating a custom method for our Registration model. This will check if an unhashed password entered by the user can be compared to the hashed password stored in our database
  Registration.prototype.validPassword = function (password) {
    return bcrypt.compareSync(password, this.password);
  };
  // Hooks are automatic methods that run during various phases of the User Model lifecycle
  // In this case, before a Registration is created, we will automatically hash their password
